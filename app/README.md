...
- Owner login through Supabase
- Protected cross-device cloud syncing, private photo/receipt storage, and local backup
- Customer and project records
- Automatic quote, contract, and invoice numbers
- Quote deletion from the dashboard or job workspace
...
Open `START-HERE-TONIGHT.md` and complete every step in order.

The legal language is a working business template, not legal advice. Have an Ohio attorney review it before routine customer use.
